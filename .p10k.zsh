# Generated by Powerlevel10k configuration wizard on 2023-11-03 at 22:35 CET.
...
() {
  ...
  function my_git_formatter() {
    ...
    if [[ -n $VCS_STATUS_LOCAL_BRANCH ]]; then
      ...
      res+="%B${clean}${(g::)POWERLEVEL9K_VCS_BRANCH_ICON}${branch//\%/%%}"
    fi
  ...
  # Custom prefix.
  typeset -g POWERLEVEL9K_VCS_PREFIX='%f%Bon '
